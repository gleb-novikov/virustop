...
public class WebClient {
    /** Ссылка на сервер. **/
    private static final String URL = "https://my-json-server.typicode.com/gleb-novikov/test-server/";
     ...
     * @param webCallback коллбэк для возвращения данных
     */
    public void getProfile(WebCallback webCallback) {
        serviceCall = apiService.getProfile();
        sentData(webCallback);
    }
